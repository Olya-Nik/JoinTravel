  ...
  render() {
    return (
      <div className="formProfile">
        ...
        City
        <TextInput
          placeholder="What place exactly?"
          onChange={this.changeCity}
        />
        Date of depature{' '}
        <DatePicker
          placeholder="Choose dates"
          onChange={this.changeDateDepature}
        />
        Date of retutn{' '}
        <DatePicker
          placeholder="Choose dates"
          onChange={this.changeDateReturn}
        />
        <Row>
          <Col m={6} s={12}>
            <Collection header="What are you interested in">
              <CollectionItem>
                <Checkbox
                  value="No"
                  label="Gastronomy"
                  onChange={this.changeGastronomy}
                />
              </CollectionItem>
              <CollectionItem>
                <Checkbox
              ...
              <CollectionItem>
                <Checkbox
                  value="No"
                  label="Sightseeings"
                  onChange={this.changeSightseeings}
                />
              </CollectionItem>
              <CollectionItem>
                <Checkbox
                  value="No"
                  label="Sea chilling"
                  onChange={this.changeSeaChilling}
                />
              </CollectionItem>
            </Collection>
          </Col>
